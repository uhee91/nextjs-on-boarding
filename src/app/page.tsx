...
//           </Link>
//           <Link href="/count" className="text-3xl font-blod underline hover:text-yellow-50">
//               {/*<a>어드민 페이지로 이동</a>*/}
//               Count 페이지로 이동
//           </Link>
//           <Link href="/count2" className="text-3xl font-blod underline hover:text-yellow-50">
//               {/*<a>어드민 페이지로 이동</a>*/}
//               Count2 페이지로 이동
//           </Link>
//           <Link href="/lifecycle" className="text-3xl font-blod underline hover:text-yellow-50">
//               {/*<a>어드민 페이지로 이동</a>*/}
//               lifecycle 페이지로 이동
//           </Link>
//
...
export default function HomePage() {
    return (
        <div>
            <h1>🏡 홈 페이지</h1>
            <p>Next.js 병렬 레이아웃과 라우팅 예제입니다.</p>
        </div>
    );
}